...
namespace ConfiguratorBackend.Migrations
{
    ...
    [Migration("20241227194838_ChangePrimaryKeyForMotherboardSlots")]
    partial class ChangePrimaryKeyForMotherboardSlots
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConfiguratorBackend.Models.Catalogue.CentralProcessor.CoreFamily", b =>
                {
                    ...
                    b.Property<int?>("UnitM2SlotID")
                        .HasColumnType("int");

                    b.Property<int?>("UnitPcieSlotID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UnitM2SlotID");

                    b.HasIndex("UnitPcieSlotID");
